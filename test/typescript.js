...
var os_1 = require("os");
var parser = __importStar(require("../parsers/typescript"));
...
function testReprinting(pattern, description) {
    ...
    describe(description, function () {
        ...
        file.indexOf("/tsx/") >= 0 ||
            ...
            file.endsWith("/optional-parameter/input.js")); }).forEach(function (file) { return it(file, function () {
...
function tryToParseFile(source, absPath) {
    try {
        ...
        try {
            var options = JSON.parse(fs_1.default.readFileSync(path_1.default.join(path_1.default.dirname(absPath), "options.json")).toString());
        }
        catch (e2) {
            if (e2.code !== "ENOENT") {
                console.error(e2);
