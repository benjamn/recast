...
function genericPrintNoParens(n, options, print) {
    ...
    case Syntax.ClassBody:
        return printStatementSequence(n.body, print);

    case Syntax.ClassPropertyDefinition:
...
function printStatementSequence(stmts, print) {
    ...
    filtered.map(print).forEach(function(lines, i) {
...
function maybeWrapParams(params, options, print) {
    ...
    if (oneLine.length === 1 && // Be conservative.
