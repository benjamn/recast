...
exports.getReprinter = function(path) {
    ...
    return function(print) {
        ...
        reprints.forEach(function(reprint) {
            ...
            // If the last character of newLines and the first character
            // after the old node are both identifier characters, they
            // must be separated by a space, otherwise they will most
            // likely get fused together into a single token.
            var newLastPos = newLines.lastPos();
            var needsTrailingSpace =
                newLines.prevPos(newLastPos) &&
                riskyAdjoiningCharExp.test(newLines.charAt(newLastPos)) &&
