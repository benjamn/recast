...
function findReprints(node, reprints) {
    ...
    var canReprint = traverseChildren(node.original, node, reprints);
...
function traverse(a, b, reprints) {
    if (a === b)
        return true;
    ...
    if (typeof a === "object") {
        ...
        var childReprints = [];
        var canReprintChildren = traverseChildren(a, b, childReprints);
...
function traverseChildren(a, b, reprints) {
