...
def("ComprehensionExpression") // TODO Implement a printer.
    .bases("Expression")
...
def("GeneratorExpression") // TODO Implement a printer.
    .bases("Expression")
    .build("body", "blocks", "filter")
    .field("body", def("Expression"))
    .field("blocks", [def("ComprehensionBlock")])
...
def("GraphExpression") // TODO Implement a printer?
    .bases("Expression")
    .build("index", "expression")
    .field("index", geq(0))
    .field("expression", def("Literal"));

def("GraphIndexExpression") // TODO Implement a printer?
    .bases("Expression")
    .build("index")
    .field("index", geq(0));
...
def("ComprehensionBlock") // TODO Implement a printer.
    .bases("Node")
...
// XJS extensions below this point (until Esprima-Harmony).
...
// Esprima-Harmony extensions below this point (until E4X).
// Since there's no spec, these types are often just a best guess.
